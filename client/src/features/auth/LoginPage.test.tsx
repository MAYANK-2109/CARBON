...
vi.mock('../../components/ui/Button', () => ({
  Button: (props: React.ButtonHTMLAttributes<HTMLButtonElement> & { isLoading?: boolean; variant?: string; children: React.ReactNode }) => (
    <button {...props} disabled={props.disabled || props.isLoading}>
      {props.children}
    </button>
  ),
}));
